...
class first_perturbation:
    ...
    def anonymizing(self):
        ...
        for i in self.attributes_domain.keys():
            ...
            perturbation_attributes.append(self.generalized_randomize_response(self.attributes_domain.get(i), perturbation_list))
        return perturbation_attributes


    def generalized_randomize_response(self, data_domain, perturbation_list):
        random_data = np.random.choice(data_domain , p=perturbation_list)
        return random_data